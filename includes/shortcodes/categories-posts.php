<?php
class ThresholdCategoriesPostsShortcode
{
    public function __construct()
    {
        // create shortcode for category posts
        add_shortcode("threshold_render_category_posts", array($this, "threshold_category_posts"));
    }
    public function threshold_category_posts($atts)
    {
